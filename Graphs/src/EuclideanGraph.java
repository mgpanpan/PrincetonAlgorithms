 ...
 */
public class EuclideanGraph extends SymbolGraph
{
    // private Draw canvas;
    // 这里假设EuclideanGraph的每个vertex是逗号分隔的坐标
    public EuclideanGraph(String filename, String delim)
    {
    ...
    public static void main(String[] args)
    {
        ...
        EuclideanGraph eg = new EuclideanGraph(filename, delimiter);
        eg.draw();
    }
}

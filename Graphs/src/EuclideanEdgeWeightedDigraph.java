...
public class EuclideanEdgeWeightedDigraph extends SymbolEdgeWeightedDigraph
{
    // private Draw canvas;
    // 这里假设EuclideanGraph的每个vertex是逗号分隔的坐标
    public EuclideanEdgeWeightedDigraph(String filename, String delim)
    {
    ...
    public void draw()
    {
        ...
        for (int v = 0; v < G.V(); v++)
        {
            ...
            for (DirectedEdge edge : G.adj(v))
                drawLine(name(edge.from()), name(edge.to()));
        }
        StdDraw.show(100);
    }
    ...
    public static void main(String[] args)
    {
        ...
        EuclideanEdgeWeightedDigraph eg = new EuclideanEdgeWeightedDigraph(filename, delimiter);
        eg.draw();
    }
}
